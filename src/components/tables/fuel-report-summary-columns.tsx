...
// Create columns function that accepts quarter parameter
export function createFuelReportSummaryColumns(
  selectedQuarter?: string
): ColumnDef<FuelReportSummary>[] {
  return [
    {
      id: "branch",
      accessorKey: "branch",
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <Link
            href={FuelReportRoute.detailPage(row.original.id, selectedQuarter)}
